...
impl WeaponKind {
    pub fn stats(self) -> WeaponStats {
        match self {
            ...
            WeaponKind::Pistol => WeaponStats { name: "Pistol", damage: 18, cooldown: 4, speed: 3, range: 25, ammo_cost: 1, bundled_ammo: 24 },
            WeaponKind::Smg => WeaponStats { name: "SMG", damage: 10, cooldown: 1, speed: 3, range: 20, ammo_cost: 1, bundled_ammo: 30 },
            WeaponKind::Shotgun => WeaponStats { name: "Shotgun", damage: 34, cooldown: 8, speed: 2, range: 8, ammo_cost: 2, bundled_ammo: 12 },
            WeaponKind::Rifle => WeaponStats { name: "Rifle", damage: 26, cooldown: 5, speed: 4, range: 35, ammo_cost: 1, bundled_ammo: 20 },
